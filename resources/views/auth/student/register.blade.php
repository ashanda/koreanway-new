                ...
                <div class="sign_form">
                    ...
                    <form action="{{ route('student_register') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            for ($i = 0; $i < $code_length; $i++) { $feed_selector=rand(0, $feed_length - 1); $final_code .=substr($code_feed, $feed_selector, 1); } @endphp <label for="stnumber" class="col-md-4 col-form-label text-md-end text-start">Student Number</label>
                                <div class="col-md-6">
