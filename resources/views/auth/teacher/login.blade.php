                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-form">
                                    ...
                                    <input type="email" placeholder="Email" id="email" class="form-control form-control-lg phone_val" placeholder="Your Email" style="border: 2px solid #ccc;" name="email" required autofocus>
